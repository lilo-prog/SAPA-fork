...
public class MedicalRecordController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Historial clínico recuperado exitosamente.",
                    content = @Content(schema = @Schema(implementation = MedicalDTO.MedicalRecordResponse.class))),
    ...
    public ResponseEntity<MedicalDTO.MedicalRecordResponse> getPatientMedicalRecord(
